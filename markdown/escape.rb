...
module EscSequence
    ...
    @color_format = {
        ...
        color_reset:  "\e[39;49m",
        colour_reset: "\e[39;49m",
    ...
    def delete_forward_char(v = 1)
        print "\e[#{v}P"
    end

    def erase_forward_char(v = 1)
        print "\e[#{v}X"
    end

    def erase_backward_char
        print "\b \b"
    end
    ...
    def set_scroll_region(line_start, line_end)
        print "\e[#{line_start};#{line_end}r"
    end
    ...
    def set_window_title_icon(title)
        print "\e]0;#{title}\a"
    end
    ...
    def horizontal_rule
      print "\e7\r\e[200G" << ("\xE2\x80\x95\b\b" * 200) << "\e8"
    end
